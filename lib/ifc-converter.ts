// Adapted from Pascal Editor's MIT-licensed @pascal-app/ifc-converter package.
// See NOTICE.md for source and attribution.
import {
  type AnyNode,
  type AnyNodeId,
  BuildingNode,
...
import {
  type IfcConversionSimplificationOptions,
  simplifyConvertedSceneGraph,
} from './ifc-cleanup'
